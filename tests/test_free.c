...
static void test_free_leaf(void) {
    ...
    leaf->num_keys = 2;
    leaf->keys[0] = 1; leaf->data.leaf.values[0] = NULL; /* no heap value */
    leaf->keys[1] = 2; leaf->data.leaf.values[1] = NULL;
...
static void test_free_inner(void) {
    ...
    left->num_keys  = 1; left->keys[0]  = 5;  left->data.leaf.values[0]  = NULL;
    right->num_keys = 1; right->keys[0] = 15; right->data.leaf.values[0] = NULL;
